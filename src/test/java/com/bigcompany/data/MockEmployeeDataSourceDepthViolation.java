...
public class MockEmployeeDataSourceDepthViolation implements EmployeeDataSource {
    ...
    public Map<String, Employee> load() {
        ...
        employees.put("E8", new Employee("E8", "NO", "Subordinate", 700, "E7")); // Depth 5 -> violation
        return employees;
    }
}
